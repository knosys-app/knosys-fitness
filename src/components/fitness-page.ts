  ...
  return function FitnessPage() {
    ...
    return React.createElement('div', { className: 'flex flex-col h-full' },
      React.createElement(Tabs, { defaultValue: 'diary', className: 'flex flex-col h-full' },
        ...
        React.createElement(TabsContent, { value: 'weight', className: 'flex-1 mt-0 p-4 lg:p-6 overflow-auto' },
          React.createElement(WeightTracker, null),
        ),
        React.createElement(TabsContent, { value: 'progress', className: 'flex-1 mt-0 p-4 lg:p-6 overflow-auto' },
          React.createElement(ProgressCharts, null),
        ),
        React.createElement(TabsContent, { value: 'recipes', className: 'flex-1 mt-0 p-4 lg:p-6 overflow-auto' },
          React.createElement(RecipeBuilder, null),
        ),
        React.createElement(TabsContent, { value: 'templates', className: 'flex-1 mt-0 p-4 lg:p-6 overflow-auto' },
